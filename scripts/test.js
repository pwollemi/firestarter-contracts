...
import { abi } from '../artifacts/contracts/formal/Presale.sol/Presale.json';
...
async function main() {
  ...
  const presale = await ethers.getContractAt(abi, "0xfaeecD3D755D1E680eF5741E5e70c48345784C01");
